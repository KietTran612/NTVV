...
- **Chế độ Dự phòng (Prompt Template)**: Xây dựng bộ Library Prompt chuẩn `[asset type] for [use case]...` để bảo chứng tính nhất quán về góc nhìn (Perspective) và ánh sáng.
