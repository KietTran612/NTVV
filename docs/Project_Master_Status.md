...
- Hỗ trợ uGUI chuẩn 1920x1080.
- **UI Standardization & Auto-Wiring**:
    - Dự án áp dụng skill `ui-standardization` để giải quyết triệt để lỗi "Dead Prefabs" và mất liên kết Inspector.
    - **Sức mạnh của Skill**: Tự động đánh giá nhu cầu Controller, ép chuẩn đặt tên hậu tố (`_Label`, `_Icon`...), dò dây đệ quy qua nhiều lớp, kiểm soát font/màu chuẩn và đăng ký sự kiện qua code.
    - Kết quả: Giảm 80% thời gian lắp ráp UI thủ công và loại bỏ 100% lỗi `NullReference` từ các thành phần Inspector bị bỏ trống.
...
- **Addressables**: Nâng cấp hệ thống Resources lên Addressables để tối ưu memory.

---

## 📝 Nhật ký Quản trị
- **2026-04-06**: Hoàn tất chuẩn hóa UI Framework & Auto-Wiring (Epic 2 nâng cao).
