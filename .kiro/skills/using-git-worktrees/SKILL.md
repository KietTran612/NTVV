...
```bash
grep -i "worktree.*director" docs/ 2>/dev/null
```
...
If no directory exists and no project docs preference:
...
- **Fix:** Follow priority: existing > project docs > ask
