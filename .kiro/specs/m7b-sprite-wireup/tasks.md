...
- [ ] 2. Wire crop_02..07 (6 SO: Potato, Corn, Wheat, Tomato, Strawberry, Pumpkin)
  - [ ] 2.0 · Resource Check
    - Map SO ID → Crop Name:
...
- [ ] 3. Wire animal_01 (Chicken) + animal_02 (Duck)
  - [ ] 3.0 · Resource Check
    ...
    - BLOCKING nếu thiếu
  - [ ] 3.4 · Asset Agent — Patch 2 animal SOs
...
- [ ] 4. Wire CropTile prefab — 4 overlay sprite (SpriteRenderer ON each Visual GameObject)
  - [ ] 4.0 · Resource Check
    ...
    - BLOCKING nếu thiếu
  - [ ] 4.4 · Prefab Agent — Update CropTile prefab SpriteRenderers
...
- [ ] 6. Reference integrity check (pre-cleanup)
  ...
  - [ ] 6.1 · Verify Legacy sprites unused (grep GUID trong .asset/.prefab/.unity)
    ...
    - _Requirements: 5.1_
  - [ ] 6.2 · Verify old world sprites chỉ CropTile prefab reference (đã repoint ở task 4)
...
- [ ] 7. Cleanup — delete unused files
  ...
  - [ ] 7.4 · Asset Agent — Delete files (theo thứ tự file → folder)
...
- [ ] 8. Integration smoke test — Play mode (API-accurate)
  - ⚠️ **Prerequisite:** Tất cả task 1-7 PASS
  - [ ] 8.1 Boot check + CropTile visual check
    ...
    - _Requirements: 6.6_
  - [ ] 8.2 Crop lifecycle — tăng tốc tick rate để test nhanh
    ...
    - _Requirements: 6.1_
  - [ ] 8.3 Ailment overlay — force via reflection
