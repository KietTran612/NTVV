...
- [ ] 0. Prerequisite — verify 13 locations (baseline)
  - [ ] 0.1 · Baseline grep
...
- [ ] 1. Fix SCN_Main.unity (1 TMP tại line ~4230)
  - [ ] 1.0 · Resource Check
...
- [ ] 2. Fix 4 prefab UI/Components (7 TMP tổng)
  - [ ] 2.0 · Resource Check
...
- [ ] 4. Post-verify — grep toàn project
  - [ ] 4.0 · Global sanity check
...
- [ ] 5. Integration smoke test — Play mode (visual confirm)
  - [ ] 5.0 · Prerequisite
