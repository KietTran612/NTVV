...
- [ ] 1. Tạo folder structure mới (empty) — **theo thứ tự dependency**
  - [ ] 1.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 1.4 · Asset Agent — Tạo folders (tool `assets-create-folder` KHÔNG đệ quy; parent PHẢI tồn tại trước)
...
- [ ] 3. Move 6 crop folders khác (Potato, Corn, Wheat, Tomato, Strawberry, Pumpkin — 36 file)
  - [ ] 3.0 · Resource Check
    - Mỗi crop 6 file (5 body + 1 seed) trong `Art/Sprites/UI/Icons/Crops/[X]/`
    - BLOCKING nếu thiếu
  - [ ] 3.4 · Asset Agent — Batch move 6 crops (thứ tự match crop_02..07 ID để align với m7b)
...
- [ ] 8a. Rename UI Icons nhóm 1 — Common + Nav + Action (8 file op)
  - [ ] 8a.0 · Resource Check
    ...
    - BLOCKING nếu thiếu
  - [ ] 8a.4 · Asset Agent — Common + Nav + Action
