...
- [ ] 0. Setup "Interactable" Layer + Camera Tag
  - [ ] 0.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 0.1 Thêm "Interactable" layer vào Project Settings
    ...
    - `editor_save_scene`
    - _Requirements: 1.1_
  - [ ] 0.2 Set tag "MainCamera" cho Main Camera
...
- [ ] 1. Viết CropGridSpawner.cs
  - [ ] 1.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 1.4 · Script Agent — Tạo CropGridSpawner.cs
...
- [ ] 2. Tạo CropTile Prefab
  ...
  - [ ] 2.1 Tạo CropTile root GameObject
    ...
    - `editor_save_scene`
    - _Requirements: 4.1_
  - [ ] 2.2 Add SoilRenderer (root level)
    ...
    - `editor_save_scene`
    - _Requirements: 4.2_
  - [ ] 2.3 Add child visual GameObjects
  ...
  - [ ] 2.4 · Script Agent — Attach CropTileView + Wire + Save Prefab
...
- [ ] 3. Generate 6 CropTiles trong CropArea
  - [ ] 3.0 · Resource Check
    - Không có sprite asset mới trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 3.1 Run CropGridSpawner
...
- [ ] 4. Setup WorldObjectPicker + PlayerInput
  - [ ] 4.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 4.1 Tạo Input Action Asset
  ...
  - [ ] 4.2 Tạo WorldObjectPicker GameObject
    - Trong `[SYSTEMS]`, tạo GO tên `"WorldObjectPicker"` (empty)
    - `editor_save_scene`
    - _Requirements: 6.1_
  - [ ] 4.4 · Script Agent — Attach WorldObjectPicker + PlayerInput (CÙNG GO)
...
- [ ] 5. Setup FarmCameraController
  - [ ] 5.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 5.4 · Script Agent — Attach FarmCameraController lên Main Camera
...
- [ ] 6. Verify [SYSTEMS] đầy đủ
  - [ ] 6.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [ ] 6.1 Verify/Add TimeManager
...
- [ ] 7. Data Check — GameDataRegistrySO
  - [ ] 7.0 · Resource Check
  ...
  - [ ] 7.1 Tạo/Verify CropDataSO Carrot placeholder
