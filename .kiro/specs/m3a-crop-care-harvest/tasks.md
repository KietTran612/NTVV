...
- [x] 0. Fix CropTileView — Care Actions + Death Visual (BUG-A1, A2, A10)
  - [x] 0.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [x] 0.4 · Script Agent — Sửa CropTileView.cs
...
- [x] 1. Fix CropTileView — HandleTick State Management (BUG-A3)
  - [x] 1.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [x] 1.4 · Script Agent — Thêm branch NeedsCare → Growing
    - `script-read` → `Assets/_Project/Scripts/World/Views/CropTileView.cs`
...
- [x] 2. Fix CropTileView — RestoreState (BUG-A6, A9)
  - [x] 2.0 · Resource Check
    - Không có sprite asset trong task này — SKIP scan
    - NON-BLOCKING
  - [x] 2.4 · Script Agent — Sửa RestoreState()
    - `script-read` → `Assets/_Project/Scripts/World/Views/CropTileView.cs`
...
- [x] 3. Fix CropActionPanelController (BUG-A4, A5, A7)
...
- [x] 4. Wire ContextActionPanel Prefab (WIRE-01)
  - [x] 4.0 · Resource Check
    ...
    - NON-BLOCKING
  - [x] 4.1 · Unity Agent — Assign _registry trong prefab
